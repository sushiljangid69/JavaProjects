/**
	* this class Notepad is the main class which has User Interface as well as the all the functionalities
...
public class Notepad implements ActionListener
{
	...
	*/
	...
	/**
		...
		looking font style 
		Note: it is named as Format in the application
		Style menu includes some menu items:
		1. Font
		2. Font Color
		3. Themes
		Style menu includes checkbox item:
		1. word wrap
	*/
	...
	/**
		...
		view menu includes the menu items:
		1. zoom in
		2. zoom out
		3. default zoom
		4. find
		5. google search
		view menu checkboxitem:
		1. show status bar
		2. show line numbers
	*/
	...
	*/
	...
	JMenuItem undo1,redo1,cut1,copy1,paste1,selectAll1,search1;		//this will work same as menu bar options but they are for popup menu or context menu when right clicked
	...
	public Notepad()
	{
		...
		search.setIcon(new ImageIcon(this.getClass().getResource("resources/search.png")));
			search1 = new JMenuItem("Google Search");
			search1.setIcon(new ImageIcon(this.getClass().getResource("resources/search.png")));
	...
	*/
	...
	/**
		...
		@param  e
		actionPerformed(ActionEvent e) listenes all the action event generated by buttons
	*/
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource() == search || e.getSource()== search1)
		{
	...
	*/
	...
	/**
		method zoom(int n)
		@param int n
		this method is responsible for zooming in,out and setting the default zoom 
	*/
	void zoom(int n)
	{
		Font f = ta.getFont();
	...
	/**
		the main frame of Edupad is not visible until the show() method is called 
		this method shows the frame f and starts the application
	*/
	public void show()
	{
		f.setVisible(true);
