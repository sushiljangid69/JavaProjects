...
public class Splash extends JFrame
{
	...
	/**
		method void iterate(void);
		iterate() method is for showing progress counting on splash screen if it is completed means 100%
		then it call the show() method of Notepad class
	*/
	public void iterate()
	{
